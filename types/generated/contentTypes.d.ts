...
export interface ApiDonorDonor extends Schema.CollectionType {
  ...
  attributes: {
    ...
    title: Attribute.Enumeration<['mr', 'mrs', 'mrAndMrs', 'none']>;
    street: Attribute.String;
    plz: Attribute.String;
    city: Attribute.String;
    country: Attribute.String;
    wantReceipt: Attribute.Boolean;
    ibans: Attribute.JSON;
    mandateNumber: Attribute.String;
    note: Attribute.Text;
